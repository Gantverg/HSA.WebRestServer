...
public class TcpProxy implements IHospital {
	...
	public String addHealthGroup(HealthGroup healthGroup) {
		...
		return getStringResponse(TcpRequest.ADD_HEALTH_GROUP, requestBody);
	}

	@Override
	public String removeHealthGroup(int groupId) {
		return getStringResponse(TcpRequest.REMOVE_HEALTH_GROUP, groupId);
	}

	@Override
	public Iterable<HealthGroup> getHealthGroups() {
		return getIterableResponse(TcpRequest.GET_HEALTH_GROUPS, "", new TypeReference<Iterable<HealthGroup>>() {});
	}
